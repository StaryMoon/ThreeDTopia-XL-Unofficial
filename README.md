...
[Paper](https://openaccess.thecvf.com/content/CVPR2025/html/Chen_3DTopia-XL_Scaling_High-quality_3D_Asset_Generation_via_Primitive_Diffusion_CVPR_2025_paper.html) · [PDF](https://openaccess.thecvf.com/content/CVPR2025/papers/Chen_3DTopia-XL_Scaling_High-quality_3D_Asset_Generation_via_Primitive_Diffusion_CVPR_2025_paper.pdf) · [Issues](https://github.com/StaryMoon/ThreeDTopia-XL-Unofficial/issues) · [Release](https://github.com/StaryMoon/ThreeDTopia-XL-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="ThreeDTopia-XL-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://openaccess.thecvf.com/content/CVPR2025/html/Chen_3DTopia-XL_Scaling_High-quality_3D_Asset_Generation_via_Primitive_Diffusion_CVPR_2025_paper.html). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>

## At a Glance

| Item | Details |
|---|---|
| Paper | 3DTopia-XL: Scaling High-quality 3D Asset Generation via Primitive Diffusion |
| Venue / Source | CVPR 2025 |
| Focus | This repository organizes a PyTorch implementation for 3DTopia-XL: Scaling High-quality 3D Asset Generation via Primitive Diffusion, focusing on high-quality 3D asset generation... |
...
This repository organizes a PyTorch implementation for **3DTopia-XL: Scaling High-quality 3D Asset Generation via Primitive Diffusion**, focusing on high-quality 3D asset generation via primitive diffusion. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```python
import torch
from threedtopia_xl_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="gaussian", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from threedtopia_xl_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 26576-26586 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Chen_3DTopia-XL_Scaling_High-quality_3D_Asset_Generation_via_Primitive_Diffusion_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Chen_3DTopia-XL_Scaling_High-quality_3D_Asset_Generation_via_Primitive_Diffusion_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Chen_3DTopia-XL_Scaling_High-quality_3D_Asset_Generation_via_Primitive_Diffusion_CVPR_2025_paper.html) |
...
- Thanks to the authors of **3DTopia-XL: Scaling High-quality 3D Asset Generation via Primitive Diffusion** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, 3d-generation, 3d-assets, primitive-diffusion
